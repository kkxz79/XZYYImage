//
//  XZDisplayExampleViewController.m
//  XZYYImage
//
...
#import "XZDisplayExampleViewController.h"
#import <YYImage/YYImage.h>
#import "UIView+YYAdd.h"
#import "XZImageExampleHelper.h"
#import <sys/sysctl.h>

@interface XZDisplayExampleViewController ()<UIGestureRecognizerDelegate> {
    UIScrollView *_scrollView;
}
@end

@implementation XZDisplayExampleViewController
...
- (void)viewDidLoad {
    ...
    label.size = CGSizeMake(self.view.width, 60.0f);
    label.top = 20.0f;
...
-(void)addImage:(UIImage*)image size:(CGSize)size text:(NSString*)text {
    ...
    //暂停/开始、前后滑动查看
    [XZImageExampleHelper addTapControlToAnimatedImageView:imageView];
    [XZImageExampleHelper addPanControlToAnimatedImageView:imageView];
